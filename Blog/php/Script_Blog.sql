...
create table COMMENTAIRE (
  ...
  constraint fk_com_bil foreign key(BIL_ID) references BILLET(BIL_ID)
) ENGINE=INNODB CHARACTER SET utf8 COLLATE utf8_general_ci;

insert into BILLET(BIL_DATE, BIL_TITRE, BIL_CONTENU) values
...
insert into COMMENTAIRE(COM_DATE, COM_AUTEUR, COM_CONTENU, BIL_ID) values
