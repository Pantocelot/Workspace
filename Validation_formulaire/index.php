      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <fieldset>
          ...
          <label for="telephone">Téléphone</label>
            <input name="telephone" type="tel" id="telephone" placeholder="par ex.&nbsp;: 0102030405"/><br/>
        	<label for="mot_de_passe">Mot de passe</label>
            <input name="mot_de_passe" type="password" id="mot_de_passe" /><br/>
        ...
        <fieldset>
        	...
        	<input type="checkbox" name="choix[]" value="services" id="services"/> <label for="services">Nos services</label><br/>
        	<input type="checkbox" name="choix[]" value="actualite" id="actualite"/> <label for="actualité">Notre actualité</label><br/>
        	<input type="checkbox" name="choix[]" value="autre" id="autre"/> <label for="autre">Autre</label><br/>
        </fieldset>
